...
/**
 * Plugin implementation of the 'generic file with class' formatter.
 *
 * @FieldFormatter(
 *   id = "file_class",
 *   label = @Translation("Generic file (with class)"),
 *   field_types = {
 *     "file"
 *   }
 * )
 */
class FileClassFormatter extends GenericFileFormatter {
